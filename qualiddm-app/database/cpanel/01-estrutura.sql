...
CREATE TABLE bug_reports (
  ...
  tipo ENUM('bug','melhoria','feature') NOT NULL DEFAULT 'bug',
  status ENUM('aberto','em_analise','aguardando_teste','resolvido','nao_corrigir','descartado') NOT NULL DEFAULT 'aberto',
  reportado_por_id BIGINT UNSIGNED NULL,
  reportado_por_nome VARCHAR(160) NULL,
  reportado_por_email VARCHAR(180) NULL,
  ...
  requisicoes_erro_json LONGTEXT NULL,
  console_erros_json LONGTEXT NULL,
  browser_json LONGTEXT NULL,
  usuario_sessao_json LONGTEXT NULL,
  acoes_usuario_json LONGTEXT NULL,
