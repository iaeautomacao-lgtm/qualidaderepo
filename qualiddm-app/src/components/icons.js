...
const icons = {
  ...
  /* IA, evidências e anexos */
  quote: (
    <>
      <path d="M9.5 6.5C6.9 7.6 5.5 9.9 5.5 13v4.5h5V12H8" />
      <path d="M19.5 6.5C16.9 7.6 15.5 9.9 15.5 13v4.5h5V12H18" />
    </>
  ),
  brain: (
    <>
      <path d="M12 5.25v13.5" />
      <path d="M9.5 5.25A2.75 2.75 0 0 0 6.9 7.1a2.6 2.6 0 0 0-1.4 4.4A2.75 2.75 0 0 0 6.6 16a2.6 2.6 0 0 0 2.9 2.75" />
      <path d="M14.5 5.25a2.75 2.75 0 0 1 2.6 1.85 2.6 2.6 0 0 1 1.4 4.4A2.75 2.75 0 0 1 17.4 16a2.6 2.6 0 0 1-2.9 2.75" />
    </>
  ),
  robot: (
    <>
      ...
      <path d="M12 4.5V8" />
      <circle cx="9.25" cy="12.75" r="1.1" />
      <circle cx="14.75" cy="12.75" r="1.1" />
      <path d="M9.75 16h4.5" />
    </>
  ),
  paperclip: (
    <path d="M19.5 11.25 11.4 19.4a4.75 4.75 0 0 1-6.7-6.7l8.6-8.6a3.15 3.15 0 0 1 4.45 4.45l-8.6 8.6a1.55 1.55 0 0 1-2.2-2.2l7.6-7.6" />
  ),
  send: (
    <>
  ...
  printer: (
    <>
      ...
      <path d="M7 17H5.5a2 2 0 0 1-2-2v-4.5a2 2 0 0 1 2-2h13a2 2 0 0 1 2 2V15a2 2 0 0 1-2 2H17" />
  ...
  eyeOff: (
    <>
      <path d="M4 4l16 16" />
      <path d="M9.6 5.3A9.9 9.9 0 0 1 12 5c5.9 0 9.5 6 9.5 6a17 17 0 0 1-2.4 3.1" />
      <path d="M6.4 7.6A17 17 0 0 0 2.5 11s3.6 6 9.5 6c1.2 0 2.3-.2 3.3-.6" />
      <path d="M10 10.1a2.75 2.75 0 0 0 3.8 3.8" />
    </>
  ),
  key: (
    <>
