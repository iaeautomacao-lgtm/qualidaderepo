...
export default function PainelGestao({ abaInicial = "operacao" }) {
  ...
  const { dados, carregando, erro, recarregar } = useRecurso(
    "/api/gestao/metricas?limiteAtividade=8",
  );
  ...
  return (
    <AppShell active="Gestão" breadcrumb={`Gestão > ${abaInicial === "usuarios" ? "Usuários" : "Operação"}`}>
      <section className="page-header">
        ...
        <div className="actions">
          <Link className="btn primary" href="/gestao/metas">
      ...
      <section className="card pad" aria-labelledby="titulo-gestao">
        <div className={styles.abasHead}>
          <h2 className={styles.abasTitulo} id="titulo-gestao">
            Gestão
          </h2>
        ...
        {erro ? (
          <p className="alert danger">
            ...
            <span className="alert-body">
              <strong>Não foi possível carregar os dados da gestão</strong>
              <span>{erro}</span>
            </span>
          </p>
        ) : null}
        ...
        >
          ...
          <section className={`card ${styles.atividade}`} aria-labelledby="atividade-recente">
            <div className="section-head">
              ...
              <Link className="btn ghost" href="/gestao/trilha-auditoria">
                Ver trilha completa
